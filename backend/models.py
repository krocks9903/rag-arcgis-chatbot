...
# ─────────────────────────────────────────────
# Admin / user-report models (used by admin_auth.py, reports.py, and the
# /reports + /admin/reports routes in app.py — see also frontend
# ReportDialog.tsx and public/admin.{html,js,css}).
# ─────────────────────────────────────────────
